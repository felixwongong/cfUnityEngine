...
{
    public class RxCollectionViewer : EditorWindow
    {
        ...
        [MenuItem("Cf Tools/Rx Collection Viewer")]
        public static void ShowPanel()
        {
            RxCollectionViewer wnd = GetWindow<RxCollectionViewer>();
            wnd.titleContent = new GUIContent(nameof(RxCollectionViewer));
        }
        ...
        private void CreateGUI()
        {
            ...
            void DrawRootCollections()
            {
                ...
                DrawCollectionTabs(_RxDebug.Instance.GetRootCollectionIds());
            }
        ...
        private void RedrawCurrentCollection()
        {
            ...
            if (TryGetCollection(_currentCollectionId, out var currentCollection))
            {
                ...
                if (_RxDebug.Instance.TryGetMutatedReferences(_currentCollectionId, out var mutatedCollectionIds))
                {
        ...
        private void DrawCollectionTabs(IList collectionIds)
        {
            ...
            _tabList.bindItem = (e, i) =>
            {
                ...
                if (_RxDebug.Instance.Collections.TryGetValue(collectionId, out var collectionRef))
                {
        ...
        {
            if (_RxDebug.Instance.CollectionSubs.TryGetValue(collection.__GetId(), out var subscriptionMap))
            {
